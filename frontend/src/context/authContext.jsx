...
export const AuthProvider = ({ children, initialRole }) => {
  ...
  const login = async (email, password) => {
    try {
      const response = await fetch('https://mobile-project-fizd.onrender.com/api/auth/login', {
        method: 'POST',
        headers: {
  ...
  const register = async (userData) => {
    try {
      const response = await fetch('https://mobile-project-fizd.onrender.com/api/auth/register', {
        method: 'POST',
        headers: {
          'Content-Type': 'application/json',
        },
  ...
  const updateProfile = async (userData) => {
    try {
      const response = await fetch('https://mobile-project-fizd.onrender.com/api/auth/profile', {
        method: 'PUT',
        headers: {
          'Content-Type': 'application/json',
